...
const MAJOR_CITIES = ['Cagayan de Oro', 'Davao', 'Zamboanga', 'General Santos'];
...
function showLoading() {
    ...
    if (currentLocation) currentLocation.textContent = 'Loading...';
    if (currentTemp) currentTemp.textContent = '--°C';
    if (currentCondition) currentCondition.textContent = 'Fetching weather data...';
}
